...
<body<?=(isset($body_class) ? " class=\"$body_class\"" : '')?>>
    ...
    <script>(function(d, s, id) {
        ...
        js.src = 'https://connect.facebook.net/en_US/sdk.js#xfbml=1&version=v3.1&appId=306416563278361&autoLogAppEvents=1';
        ...
        <header>
            ...
            <div class="not-logo">
                <div class="social">
                    ...
                    <a href="https://www.facebook.com/FunlandUlladulla/" target="_blank" title="View Funland Australia on Facebook">
                    ...
                    <a href="https://www.instagram.com/ulladullafunland/" target="_blank" title="View Funland Australia on Instagram">
